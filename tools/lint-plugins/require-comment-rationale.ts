...
const EXCLUDED_PATHS: readonly string[] = [
  ...
  "/tools/print-tts.ts",
  "/tools/test/nim-parser.test.ts",
  "/tools/test/prefab-html.test.ts",
  "/tools/test/prefab-xml.test.ts",
  "/tools/test/print-png-pixel-stat.test.ts",
  "/tools/test/tts-parser.test.ts",
