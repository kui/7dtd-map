...
exports.TerrainViewerCameraController = void 0;
...
const MAX_ELEV = 255;
class TerrainViewerCameraController {
  constructor(canvas, camera) {
    this.terrainSize = (0, utils_1.threePlaneSize)(1, 1);
    this.mapWidth = 1;
    this.minZ = 1;
    this.maxZ = 1;
    this.speeds = { x: 0, y: 0, tilt: 0 };
    this.mouseMove = {
      left: { x: 0, y: 0 },
      right: { x: 0, y: 0 },
      center: { x: 0, y: 0 },
  ...
  moveCameraXY(deltaMsec) {
    ...
    const lookAt = (0, utils_1.requireNonnull)(this.pointLookAtXYPlane());
  ...
  tiltCamera(deltaMsec) {
    ...
    const center = (0, utils_1.requireNonnull)(this.pointLookAtXYPlane());
...
exports.TerrainViewerCameraController = TerrainViewerCameraController;
